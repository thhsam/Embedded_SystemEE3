...
class GameBoard(tk.Frame):
    def __init__(self, parent, rows=8, columns=8, size=64, color1="blue", color2="orange"):
...
if __name__ == "__main__":
    ...
    knightW = Image.open("knightW.png")
    player1 = tk.PhotoImage(file = "knightW.gif")
